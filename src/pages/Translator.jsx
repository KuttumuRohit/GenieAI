...
const Translator = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      // Call Flask API
      const response = await fetch('http://127.0.0.1:5000/api/translator', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
      <div className="bg-white rounded-lg shadow-md w-full max-w-3xl p-6">
        <h1 className="text-2xl font-bold mb-4 text-center"><b>Translator</b></h1>
        ...
        <div className="flex items-center gap-3 mb-4">
          <input
            ...
            placeholder="Type text to translate | target language (e.g., Hello | Spanish)"
            value={input}
